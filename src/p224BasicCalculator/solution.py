...
class Solution:
    def calculate(self, s):
        ...
        """
        s = '(' + s + ')'
        character = [chr(i + ord('0')) for i in range(10)]
        stack = []
        i = 0
        while i < len(s):
            if s[i] == ' ':
                ...
                number = []
                while i < len(s) and s[i] in character:
                    number.append(s[i])
                    i += 1
                i -= 1
...
if __name__ == '__main__':
    ...
    print(Solution().calculate(" 2-1 + 2 "))
    print(Solution().calculate("((4+((1-(-+-10)))))"))
    print(Solution().calculate("  30"))
    print(Solution().calculate("10 - 1"))
